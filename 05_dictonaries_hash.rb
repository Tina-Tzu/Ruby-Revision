...
my_details={'name'=>'Tina','age'=>30,'country'=>'Bangladesh'}
puts my_details['name']
the_details={name:'Tina',age:30,country:'Bangladesh'}
puts the_details[:country]
puts "*"*30
puts the_details.keys
puts "*"*30
puts the_details.values

the_details.each do |k,v|
  puts "The key is #{k} and the value is #{v}"
end
puts "*"*30

the_details[:hobby]="Coding"
puts the_details
the_details.delete(:age)
puts the_details
the_details[:country]="Japan"
puts the_details

kp=my_details.select {|theKay,theValue| theValue.is_a?(String) ? theKay : nil}
puts kp
